    ...
    return (
      <div>
        ...
        **NOTE** Time Attack requires a CACC competition licence to participate. 
        ...
        <ul class="list-group">
          <li class="list-group-item"><a href="" target="_blank" rel="noopener noreferrer">Auto Slalom Rule Book (CACC)</a></li>
          <li class="list-group-item"><a href="" target="_blank" rel="noopener noreferrer">IceX supplemental regulations ( Cars On Ice )</a></li>
          <li class="list-group-item"><a href="" target="_blank" rel="noopener noreferrer">Time Attack Rule Book (CACC)</a></li>
          <li class="list-group-item"><a href="" target="_blank" rel="noopener noreferrer">Time Attack Supplemental Regulations ( Cars On Ice )</a></li>
          <li class="list-group-item"><a href="" target="_blank" rel="noopener noreferrer">IceX and Time attack Tech Forms (Please print and fill out, making sure your car is compliant)</a></li>
        </ul>

        <h3 className="my-3">Ice Racing (Wheel to Wheel) Car Preparation</h3>
        <ul class="list-group">
          <li class="list-group-item"><a href="" target="_blank" rel="noopener noreferrer">CACC GCR for Car building specifications</a></li>
          <li class="list-group-item"><a href="" target="_blank" rel="noopener noreferrer">CACC Ice Racing Discipline Car Preparation Specifications</a></li>
          <li class="list-group-item"><a href="" target="_blank" rel="noopener noreferrer">Cars on Ice Supplemental Rule Book</a></li>
        </ul>
      </div>
    );
  }
